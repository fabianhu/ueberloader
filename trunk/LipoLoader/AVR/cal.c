...
int16_t anCalCellsGain[6] = 	{ GAINMULTIPLIER, GAINMULTIPLIER, GAINMULTIPLIER, GAINMULTIPLIER,GAINMULTIPLIER, GAINMULTIPLIER }; // { 10174, 10152, 10157, 10149, 10169, 10179 };
int16_t anCalCellsOffset[6] =  { 0, 0, 0, 0, 0, 0 };//{ -6, 0, -2, 0, -4, -2 };
