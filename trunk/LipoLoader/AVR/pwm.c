...
uint16_t PID(int32_t diff, int32_t* I, uint16_t kP, int16_t kI, uint16_t kD,
		int16_t lowerLimit, int16_t upperLimit)
{
#define I_REDUCTION 255 // to get smoother I, it calculates in multiples of this.
	...
	*I =
			limit(*I,(uint32_t)lowerLimit*I_REDUCTION,(uint32_t)upperLimit*I_REDUCTION); // wind-up protection
