...
MenuItem_t m_items[MENUESIZE] = { \
	...
	/* 10*/	{txtCHARGELIPONOW,	 ActionChargeModeLiPo,	 0,	0,	1,	FLASH}, \
	/* 11*/	{txtCHARGELIIONOW,	 ActionChargeModeLiIo,	 0,	0,	1,	FLASH}, \
	/* 12*/	{txtCHARGELIFENOW,	 ActionChargeModeLiFe,	 0,	0,	1,	FLASH}, \
	/* 13*/	{txtSTORAGENOW,	 ActionChargeModeStorage,	 0,	0,	1,	FLASH}, \
	/* 14*/	{txtDISCHARGENOW,	 ActionChargeModeDischarge,	 0,	0,	1,	FLASH}, \
	...
	/* 21*/	{txtBACK,	 menuUpnSave,	 0,	0,	16,	FLASH}, \
